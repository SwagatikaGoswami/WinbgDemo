// MySampleAtl.cpp : Implementation of the MySampleAtl class

#include "stdafx.h"
#include <propkey.h>
#include "MySampleAtl.h"

HRESULT MySampleAtl::LoadFromStream(IStream* pStream, DWORD grfMode)
{
...
void MySampleAtl::InitializeSearchContent()
{
...
void MySampleAtl::SetSearchContent(CString& value)
{
...
void MySampleAtl::OnDrawThumbnail(HDC hDrawDC, LPRECT lprcBounds)
{
